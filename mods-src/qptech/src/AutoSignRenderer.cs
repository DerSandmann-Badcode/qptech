...
namespace qptech.src
{
    public class AutoSignRenderer : IRenderer
    {
        ...
        public float translateY = 0.5f;//default 0.5625f
        ...
        public AutoSignRenderer(BlockPos pos, ICoreClientAPI api)
        {
            this.api = api;
            this.pos = pos;
        ...
        public virtual void SetNewText(string text, int color)
        {
            ...
            if (text.Length > 0)
            {
                ...
                loadedTexture = api.Gui.TextTexture.GenTextTexture(text, font, TextWidth, TextHeight, null, EnumTextOrientation.Left, false);
            }
        }
